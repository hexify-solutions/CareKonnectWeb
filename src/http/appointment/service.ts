...
export const makePaymentForAppointment = <T extends { provider: string; appointmentId: string }>(params: T) => {
  return api.post(endPoints.payment, params)
}

export const verifyPaymentForAppointment = <T extends { provider: string; reference: string }>(params: T) => {
