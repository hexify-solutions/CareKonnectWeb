        ...
        <div className={styles.showCaseSection}>
          <div className={clsx(styles.showCaseItem, styles.innovation)}>
            ...
            <span className={styles.subLead}>
              Enhances healthcare access for underserved populations via online
              consultations, mobile apps, and remote monitoring.
            </span>
          ...
          <div className={clsx(styles.showCaseItem, styles.compliant)}>
            ...
            <span className={styles.subLead}>
              ...
              standards designed to ensure patient safety, privacy, and quality
              of care.
            </span>
            <aside className={styles.showCaseImageWrapper}>
